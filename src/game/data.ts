...
export const LANDING_COPY = {
  eyebrow: '3 位真人玩家，1 个 AI 看山“卧底”',
  titleTop: '快来知乎',
  titleBottom: '找人机！',
  subtitle: '虚实相间，人机博弈。',
  description: '三轮游戏，三次投票；玩家故作“入机”，找寻 AI “卧底”。玩家投对“卧底” +2 分，票数最高者 +3 分。',
  primaryAction: '开始游戏',
...
export const ROUND_TOPICS: Record<RoundNumber, RoundTopic> = {
  1: {
    ...
    kicker: '第一轮 · 有梗的帖子',
    title: '为什么《牛来》能申请到龙标？',
    task: '写一条评论。你可以故意 “AI味”，也可以顺着题目玩梗；所有人写完后，投出你心中的“AI”卧底。',
  ...
  2: {
    ...
    task: '你将对一个知乎上的专业领域问题概念做解释；所有人写完后，投出你心中的“AI”卧底。',
    context: '把 duo 当作一个词来谈你的理解。',
    sourceType: '游戏题目',
    maxChars: 50,
    contentKind: '评论',
  ...
  3: {
    ...
    title: '#西游记',
    task: '围绕 #西游记，提一个问题。',
    context: '你将围绕给定tag设计一个问题；所有人写完后，投出你心中的“AI”卧底。',
    sourceType: '主题标签',
    maxChars: 30,
    contentKind: '问题',
